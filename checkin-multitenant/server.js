...
app.post('/api/admin/data', adminAuth, (req, res) => {
    const { theme } = req.ctx;
    res.json({ success: true, data: { attendees: theme.attendees, checkins: theme.checkins, signups: theme.signups, questions: theme.questions || [], settings: theme.settings || {} } });
});

// 管理员配置本主题的报名题目与名单校验策略
app.post('/api/theme/config', adminAuth, (req, res) => {
